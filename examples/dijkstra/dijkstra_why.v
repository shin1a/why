...
(*Why predicate*) Definition Is_empty (A160:Set) (s:(set A160))
  := (forall (x:A160), ~(In x s)).
Implicit Arguments Is_empty.

(*Why predicate*) Definition Incl (A161:Set) (s1:(set A161)) (s2:(set A161))
  := (forall (x:A161), ((In x s1) -> (In x s2))).
...
(* Why obligation from file "dijkstra.why", line 223, characters 1-41: *)
(*Why goal*) Lemma shortest_path_po_1 : 
  ...
  forall (HW_2: (Is_empty S) /\ Q = (set_add src (@set_empty vertex)) /\
                d0 = (map_set d src 0)),
  ((Inv src S Q d0) /\ (InvSucc src S Q)).
Proof.
(* FILL PROOF HERE *)
Save.

(* Why obligation from file "dijkstra.why", line 227, characters 13-48: *)
(*Why goal*) Lemma shortest_path_po_2 : 
  ...
  forall (HW_5: ~(Is_empty Q0)),
  forall (result: vertex),
  forall (Q1: (set vertex)),
  forall (HW_6: (Min result Q0 d1) /\ Q1 = (set_rmv result Q0)),
  (shortest_path src result (map_get d1 result)).
Proof.
(* FILL PROOF HERE *)
Save.

(* Why obligation from file "dijkstra.why", line 232, characters 3-78: *)
(*Why goal*) Lemma shortest_path_po_3 : 
  ...
  forall (Q1: (set vertex)),
  forall (HW_6: (Min result Q0 d1) /\ Q1 = (set_rmv result Q0)),
  forall (HW_7: (shortest_path src result (map_get d1 result))),
  forall (S1: (set vertex)),
  forall (HW_8: S1 = (set_add result S0)),
  ((Incl (g_succ result) (g_succ result)) /\ (Inv src S1 Q1 d1) /\
...
(*Why goal*) Lemma shortest_path_po_4 : 
  ...
  forall (HW_9: (Incl su (g_succ result)) /\ (Inv src S1 Q2 d2) /\
                (InvSucc2 src S1 Q2 result su)),
  forall (HW_10: ~(Is_empty su)),
  forall (HW_11: ~(Is_empty su)),
  forall (result0: vertex),
  forall (su0: (set vertex)),
  forall (HW_12: (In result0 su) /\ su0 = (set_rmv result0 su)),
  forall (Q3: (set vertex)),
  forall (d3: (map vertex Z)),
  forall (HW_13: (In result0 S1) /\ Q3 = Q2 /\ d3 = d2 \/ (In result0 Q3) /\
                 ...
                 (map_set
                  d2 result0 ((map_get d3 result) + (weight result result0)))),
  ((Incl su0 (g_succ result)) /\ (Inv src S1 Q3 d3) /\
  (InvSucc2 src S1 Q3 result su0)).
Proof.
(* FILL PROOF HERE *)
Save.

(* Why obligation from file "dijkstra.why", line 235, characters 3-15: *)
(*Why goal*) Lemma shortest_path_po_5 : 
  ...
  forall (HW_13: (In result0 S1) /\ Q3 = Q2 /\ d3 = d2 \/ (In result0 Q3) /\
                 ...
                 (map_set
                  d2 result0 ((map_get d3 result) + (weight result result0)))),
  (Zwf 0 (set_card su0) (set_card su)).
Proof.
(* FILL PROOF HERE *)
Save.
...
(*Why goal*) Lemma shortest_path_po_6 : 
  ...
  ((Inv src S1 Q2 d2) /\ (InvSucc src S1 Q2)).
Proof.
(* FILL PROOF HERE *)
Save.

(* Why obligation from file "dijkstra.why", line 225, characters 1-26: *)
(*Why goal*) Lemma shortest_path_po_7 : 
  ...
  forall (HW_9: (Incl su (g_succ result)) /\ (Inv src S1 Q2 d2) /\
                (InvSucc2 src S1 Q2 result su)),
  forall (HW_14: (Is_empty su)),
  (Zwf 0 ((set_card V) - (set_card S1)) ((set_card V) - (set_card S0))).
Proof.
(* FILL PROOF HERE *)
Save.

(* Why obligation from file "dijkstra.why", line 240, characters 4-148: *)
(*Why goal*) Lemma shortest_path_po_8 : 
  ...
  forall (d1: (map vertex Z)),
  forall (HW_3: (Inv src S0 Q0 d1) /\ (InvSucc src S0 Q0)),
  forall (HW_15: (Is_empty Q0)),
  ((forall (v:vertex), ((In v S0) -> (shortest_path src v (map_get d1 v)))) /\
  (forall (v:vertex), (~(In v S0) -> (forall (dv:Z), ~(path src v dv))))).
Proof.
(* FILL PROOF HERE *)
Save.
