...
struct
  type t = X.t
  let compare v1 v2 = Stdlib.compare (X.tag_of_val v1) (X.tag_of_val v2)
...
module VariantOrd = struct
  type t = root_info
  let compare v1 v2 = 
    Stdlib.compare v1.jc_root_info_name v2.jc_root_info_name
  let equal v1 v2 =
...
module LogicLabelOrd =
  struct type t = label
	 let compare = (Stdlib.compare : label -> label -> int)
  end
